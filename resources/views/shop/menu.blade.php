...
<body data-page="home" class="antialiased w-full max-w-[420px] mx-auto bg-gray-50 min-h-screen relative shadow-2xl overflow-x-hidden pb-24 page-transition">
    ...
    <div id="splash-screen" class="fixed inset-0 max-w-[420px] mx-auto bg-white z-[100] flex flex-col items-center justify-center transition-opacity duration-500">
        ...
        <h1 class="text-primary text-3xl font-extrabold tracking-widest uppercase" style="{{ $shop->title_font_family === 'poppins' ? 'font-family: Poppins, sans-serif;' : ($shop->title_font_family === 'playfair' ? 'font-family: \'Playfair Display\', serif;' : ($shop->title_font_family === 'nunito' ? 'font-family: Nunito, sans-serif;' : '')) }}">{{ $shop->name }}</h1>
            ...
            <div class="flex items-center justify-between px-1 pb-2">
                <div class="flex items-center gap-2">
                    ...
                    <div class="flex flex-col">
                        <span class="font-extrabold text-[15px] leading-tight tracking-tight text-primary uppercase" style="{{ $shop->title_font_family === 'poppins' ? 'font-family: Poppins, sans-serif;' : ($shop->title_font_family === 'playfair' ? 'font-family: \'Playfair Display\', serif;' : ($shop->title_font_family === 'nunito' ? 'font-family: Nunito, sans-serif;' : '')) }}">{{ $shop->name }}</span>
    ...
    <div id="modal-item-detail" class="fixed inset-0 max-w-[420px] mx-auto z-50 hidden flex flex-col justify-end p-0">
        ...
        <div class="relative bg-white w-full rounded-t-3xl bottom-sheet flex flex-col max-h-[85vh][90vh]">
            ...
            <div class="overflow-y-auto px-5 pb-24 hide-scroll relative">
                <!-- Close Button Inside -->
                <button onclick="closeItemDetail()" class="absolute top-2 right-5 w-8 h-8 bg-black/5 rounded-full flex items-center justify-center text-gray-700 hover:bg-black/10 transition z-10">
                    <i class="fas fa-times"></i>
                </button>

                <img id="detail-img" src="" alt="Product" class="w-full h-48 object-cover rounded-2xl mb-4 shadow-sm border border-gray-100">
                
                <h3 id="detail-name" class="font-extrabold text-2xl text-gray-800 leading-tight mb-1 pr-12">Nama Produk</h3>
